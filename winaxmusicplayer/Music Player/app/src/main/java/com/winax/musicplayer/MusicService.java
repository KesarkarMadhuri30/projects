...
import com.winax.musicplayer.data.eq.BassBoosts;
import com.winax.musicplayer.data.eq.Equalizers;
import com.winax.musicplayer.data.eq.Loud;
import com.winax.musicplayer.data.eq.Reverb;
import com.winax.musicplayer.data.eq.Virtualizers;
import com.winax.musicplayer.helpers.MediaButtonIntentReceiver;
import com.winax.musicplayer.helpers.MusicPlaybackTrack;
import com.winax.musicplayer.permissions.Nammu;
import com.winax.musicplayer.provider.MusicPlaybackState;
import com.winax.musicplayer.provider.RecentStore;
import com.winax.musicplayer.provider.SongPlayCount;
...
import com.winax.musicplayer.utils.SleepTimer;
import com.winax.musicplayer.utils.TimberUtils;
import com.winax.musicplayer.utils.TimberUtils.IdType;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.winax.musicplayer.playstatechanged";
    public static final String POSITION_CHANGED = "com.winax.musicplayer.positionchanged";
    public static final String META_CHANGED = "com.winax.musicplayer.metachanged";
    public static final String QUEUE_CHANGED = "com.winax.musicplayer.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.winax.musicplayer.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.winax.musicplayer.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.winax.musicplayer.shufflemodechanged";
    public static final String TRACK_ERROR = "com.winax.musicplayer.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "com.winax.musicplayer.timber";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.winax.musicplayer.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.winax.musicplayer.togglepause";
    public static final String PAUSE_ACTION = "com.winax.musicplayer.pause";
    public static final String STOP_ACTION = "com.winax.musicplayer.stop";
    public static final String PREVIOUS_ACTION = "com.winax.musicplayer.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.winax.musicplayer.previous.force";
    public static final String NEXT_ACTION = "com.winax.musicplayer.next";
    public static final String REPEAT_ACTION = "com.winax.musicplayer.repeat";
    public static final String SHUFFLE_ACTION = "com.winax.musicplayer.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.winax.musicplayer.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.winax.musicplayer.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.winax.musicplayer.shutdown";
    ...
    private Notification buildNotification() {
        ...
        if (artwork == null) {
            artwork = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.icon_music);
        }
...
//            }
    ...
    private void otherstuff() {
        ...
        if (Nammu.isAudioRecordGranted(this)) {
