...
package com.winax.musicplayer.nowplaying;
...
import com.winax.musicplayer.adapters.BaseQueueAdapter;
import com.winax.musicplayer.dataloaders.QueueLoader;
import com.winax.musicplayer.listeners.MusicStateListener;
import com.winax.musicplayer.timely.TimelyView;
...
import com.winax.musicplayer.widgets.CircularSeekBar;
import com.winax.musicplayer.widgets.DividerItemDecoration;
import com.winax.musicplayer.widgets.PlayPauseButton;
import com.winax.musicplayer.widgets.PlayPauseDrawable;
                ...
                ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
                        new DisplayImageOptions.Builder().cacheInMemory(true)
                            ...
                            public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                                Bitmap failedBitmap = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.icon_music);
