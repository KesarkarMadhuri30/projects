...
import com.winax.musicplayer.ITimberService;
import com.winax.musicplayer.MusicPlayer;
import com.winax.musicplayer.MusicService;
import com.winax.musicplayer.R;
import com.winax.musicplayer.listeners.MusicStateListener;
//import com.winax.musicplayer.services.MusicXService;
import com.winax.musicplayer.slidinguppanel.SlidingUpPanelLayout;
import com.winax.musicplayer.subfragments.QuickControlsFragment;
...
public abstract class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
   ...
   /*@Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_main,menu);
        ATE.applyMenu(BaseActivity.this,getATEKey(),menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
           ...
           /* Intent intent = new Intent(AudioEffect.ACTION_DISPLAY_AUDIO_EFFECT_CONTROL_PANEL);
            if (intent.getAction() != null && NavigationUtils.isActivityPresent(BaseActivity.this, intent)){
...
//                   baseActivity.mPlayPauseProgressButton.getPlayPauseButton().updateState();
                    ...
                    @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) final String errorMsg = context.getString(R.string.error_playing_track,
