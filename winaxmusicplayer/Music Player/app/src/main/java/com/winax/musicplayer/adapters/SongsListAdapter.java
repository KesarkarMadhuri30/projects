...
package com.winax.musicplayer.adapters;
...
import com.winax.musicplayer.dialogs.AddFavoriteDialog;
import com.winax.musicplayer.dialogs.AddPlaylistDialog;
...
import com.winax.musicplayer.widgets.BubbleTextGetter;
import com.winax.musicplayer.widgets.MusicVisualizer;
...
public class SongsListAdapter extends RecyclerView.Adapter<SongsListAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(localItem.albumId).toString(), itemHolder.albumArt, new DisplayImageOptions.Builder().cacheInMemory(true).showImageOnFail(R.drawable.icon_music).resetViewBeforeLoading(true).build());
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.popup_song_addto_playlist:
                                ...
                                break;
                            case R.id.popup_song_addto_favorite:

                                AddFavoriteDialog.newInstance(arraylist.get(position)).show(mContext.getSupportFragmentManager(), "ADD_FAVORITE");
                                break;
                        }
                        return false;
                    }
    ...
    private void removeSongAt(int position) {
