...
import com.winax.musicplayer.fragments.MainFragment;
import com.winax.musicplayer.fragments.PlaylistFragment;
import com.winax.musicplayer.fragments.QueueFragment;
import com.winax.musicplayer.permissions.Nammu;
import com.winax.musicplayer.permissions.PermissionCallback;
import com.winax.musicplayer.slidinguppanel.SlidingUpPanelLayout;
import com.winax.musicplayer.subfragments.LyricsFragment;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    Runnable navigateEqualizer = new Runnable() {
        @Override
        public void run() {
            navigateEqualizer.run();
    ...
    Runnable navigateFavorites = new Runnable() {
        public void run() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        navigationMap.put(Constants.NAVIGATE_FAVORITES, navigateFavorites);
        navigationMap.put(Constants.NAVIGATE_EQUALIZER, navigateEqualizer);
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "Winax Player will need to read external storage to display songs on your device.",
    ...
    private void setupNavigationIcons(NavigationView navigationView) {
        ...
        if (!isDarkTheme) {
            ...
            navigationView.getMenu().findItem(R.id.nav_favorites).setIcon(R.drawable.ic_favorite_black);
            ...
            navigationView.getMenu().findItem(R.id.nav_equalizer).setIcon(R.drawable.ic_equalizer_white_24dp);
            navigationView.getMenu().findItem(R.id.nav_favorites).setIcon(R.drawable.ic_favorite_white);
    ...
    private void updatePosition(final MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_equalizer:
                NavigationUtils.navigateToEqualizer(MainActivity.this,false);
                break;
            case R.id.nav_help:
                Intent intent = new Intent(Intent.ACTION_VIEW);
                Uri data = Uri.parse("mailto:madhurikesarkar8@gmail.com");
                intent.setData(data);
    ...
    public void setDetailsToHeader() {
        ...
        ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
                new DisplayImageOptions.Builder().cacheInMemory(true)
                        .showImageOnFail(R.drawable.crop)
