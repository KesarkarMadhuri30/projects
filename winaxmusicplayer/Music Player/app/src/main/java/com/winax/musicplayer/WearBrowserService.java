...
import com.winax.musicplayer.dataloaders.AlbumLoader;
import com.winax.musicplayer.dataloaders.AlbumSongLoader;
import com.winax.musicplayer.dataloaders.ArtistAlbumLoader;
import com.winax.musicplayer.dataloaders.ArtistLoader;
import com.winax.musicplayer.dataloaders.ArtistSongLoader;
...
import com.winax.musicplayer.models.Album;
import com.winax.musicplayer.models.Artist;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "winax.musicplayer/drawable/icon_music"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "winax.musicplayer/drawable/icon_music"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "winax.musicplayer/drawable/icon_music"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "winax.musicplayer/drawable/icon_music"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
